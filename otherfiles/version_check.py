...
README_ITEMS = [
    "[Version {0}](https://github.com/sepandhaghighi/typio/archive/v{0}.zip)",
    "pip install typio=={0}"]

SETUP_ITEMS = [
    "version='{0}'",
    "https://github.com/sepandhaghighi/typio/tarball/v{0}"]

CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/sepandhaghighi/typio/compare/v{0}...dev",
    "[{0}]:"]
